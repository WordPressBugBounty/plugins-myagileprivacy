...
<div class="row" id="cookie_banner_options_container">
    <div class="col-sm-8">
        ...
        <div class="consistent-box">
            ...
            <div class="row mb-4">
                <label for="is_on_field_yes" class="col-sm-5 col-form-label">
                    <?php _e( 'Enable Cookie Banner', 'myagileprivacy' ); ?>
                </label>
                ...
                <div class="col-sm-7">
                    <div class="styled_radio d-inline-flex">
                        <div class="round d-flex me-4">
                            <?php if( $the_options['is_on'] == true ): ?>
                                ...
                                <label for="is_on_field_yes"><?php _e( 'On', 'myagileprivacy' ); ?></label>
                        ...
                        <div class="round d-flex">
                            <?php if( $the_options['is_on'] == false ): ?>
                                ...
                                <label for="is_on_field_no"><?php _e( 'Off', 'myagileprivacy' ); ?></label>
                            <?php else: ?>
                    ...
                    <div class="form-text">
                        <?php
                            _e( "Choose if the cookie banner should be visible on the website",'myagileprivacy' );
                        ?>.
                    </div>
                </div> <!-- /.col-sm-6 -->
            ...
            <div class="row mb-4">
                <label for="cookie_banner_size_field" class="col-sm-5 col-form-label">
                    <?php _e( 'Banner Size', 'myagileprivacy' ); ?>
                </label>
                <div class="col-sm-7">
                    <select name="cookie_banner_size_field" class="form-control hideShowInput" id="cookie_banner_size_field" data-preview="mapSize" data-hide-show-ref="cookie_banner_size">
                        <option value="sizeWide" <?php selected( $the_options['cookie_banner_size'], 'sizeWide' ); ?>><?php _e( 'Wide', 'myagileprivacy' ); ?></option>
                        <option value="sizeBig" <?php selected( $the_options['cookie_banner_size'], 'sizeBig' ); ?>><?php _e( 'Big', 'myagileprivacy' ); ?></option>
                        <option value="sizeBoxed" <?php selected( $the_options['cookie_banner_size'], 'sizeBoxed' ); ?>><?php _e( 'Boxed', 'myagileprivacy' ); ?></option>
                    </select>
                </div> <!-- col-sm-7 -->
            </div> <!-- row -->
            ...
            <div class="row mb-4">
                <label for="cookie_banner_vertical_position_field" class="col-sm-5 col-form-label">
                    <?php _e( 'Vertical Banner Position', 'myagileprivacy' ); ?>
                </label>
                <div class="col-sm-7">
                    <select name="cookie_banner_vertical_position_field" class="form-control" id="cookie_banner_vertical_position_field" data-preview="mapPosition">
                        ...
                        <option value="Top" <?php selected( $the_options['cookie_banner_vertical_position'], 'Top' ); ?>><?php _e( 'Top', 'myagileprivacy' ); ?></option>
                        <option value="Center" <?php selected( $the_options['cookie_banner_vertical_position'], 'Center' ); ?>><?php _e( 'Center', 'myagileprivacy' ); ?></option>
                        <option value="Bottom" <?php selected( $the_options['cookie_banner_vertical_position'], 'Bottom' ); ?>><?php _e( 'Bottom', 'myagileprivacy' ); ?></option>
                    </select>
                </div> <!-- col-sm-7 -->
            </div> <!-- row -->
            ...
            <div class="cookie_banner_size displayNone" data-value="sizeBig sizeBoxed">
                ...
                <div class="row mb-4">
                    <label for="cookie_banner_horizontal_position_field" class="col-sm-5 col-form-label">
                        <?php _e( 'Horizontal Banner Position', 'myagileprivacy' ); ?>
                    </label>
                    <div class="col-sm-7">
                        <select name="cookie_banner_horizontal_position_field" class="form-control" id="cookie_banner_horizontal_position_field" data-preview="mapPosition">
                            ...
                            <option value="Center" <?php selected( $the_options['cookie_banner_horizontal_position'], 'Center' ); ?>><?php _e( 'Center', 'myagileprivacy' ); ?></option>
                            <option value="Left" <?php selected( $the_options['cookie_banner_horizontal_position'], 'Left' ); ?>><?php _e( 'Left', 'myagileprivacy' ); ?></option>
                            <option value="Right" <?php selected( $the_options['cookie_banner_horizontal_position'], 'Right' ); ?>><?php _e( 'Right', 'myagileprivacy' ); ?></option>
                        </select>
                    </div> <!-- col-sm-7 -->
                </div> <!-- row -->
            ...
            <div class="row mb-4">
                <label for="floating_banner_field" class="col-sm-5 col-form-label">
                    <?php _e( 'Floating Banner', 'myagileprivacy' ); ?>
                </label>
                ...
                <div class="col-sm-7">
                    <select name="floating_banner_field" class="form-control" id="floating_banner_field" data-preview="floating_banner">
                        ...
                        <option value="1" <?php selected( $the_options['floating_banner'], 1 ); ?>><?php _e( 'Yes', 'myagileprivacy' ); ?></option>
                    </select>
                </div> <!-- /.col-sm-6 -->
            </div> <!-- row -->
            ...
            <div class="row mb-4">
                <label for="cookie_banner_shadow_field" class="col-sm-5 col-form-label">
                    <?php _e( 'Cookie Banner Shadow', 'myagileprivacy' ); ?>
                </label>
                <div class="col-sm-7">
                    <select name="cookie_banner_shadow_field" class="form-control" id="cookie_banner_shadow_field" data-preview="shadow">
                        <option value="false" <?php selected( $the_options['cookie_banner_shadow'], 'false' ); ?>><?php _e( 'None', 'myagileprivacy' ); ?></option>

                        <option value="map-shadow-soft" <?php selected( $the_options['cookie_banner_shadow'], 'map-shadow-soft' ); ?>><?php _e( 'Soft', 'myagileprivacy' ); ?></option>

                        <option value="map-shadow-hard" <?php selected( $the_options['cookie_banner_shadow'], 'map-shadow-hard' ); ?>><?php _e( 'Strong', 'myagileprivacy' ); ?></option>
                    </select>

                    <div class="form-text">
                        <?php _e( 'Select the shadow effect for the cookie banner', 'myagileprivacy' ); ?>.
                    </div>
                </div> <!-- col-sm-7 -->
            </div> <!-- row -->
            ...
            <div class="row mb-4">
                <label for="elements_border_radius_field" class="col-sm-5 col-form-label">
                    <?php _e( 'Elements Border Radius', 'myagileprivacy' ); ?>
                </label>
                <div class="col-sm-7">
                ...
                <input type="number" min="0" max="50" data-preview="border_radius" class="form-control" id="elements_border_radius_field" name="elements_border_radius_field" value="<?php echo esc_attr(stripslashes($the_options['elements_border_radius']))  ?>" />
                    ...
                    <div class="form-text">
                        <?php _e( 'Insert the border radius value for cookie banner and buttons, in pixel', 'myagileprivacy' ); ?>
                    </div>
                </div> <!-- col-sm-7 -->
            </div> <!-- row -->
            ...
            <div class="row mb-4">
                <label for="cookie_banner_animation_field" class="col-sm-5 col-form-label">
                    <?php _e( 'Banner Animation Effect', 'myagileprivacy' ); ?>
                </label>
                <div class="col-sm-7">
                <select name="cookie_banner_animation_field" class="form-control" id="cookie_banner_animation_field">
                    <option value="none" <?php selected( $the_options['cookie_banner_animation'], 'none' ); ?>><?php _e( 'None', 'myagileprivacy' ); ?></option>
                    <option value="slide" <?php selected( $the_options['cookie_banner_animation'], 'slide' ); ?>><?php _e( 'Slide', 'myagileprivacy' ); ?></option>
                    <option value="fade" <?php selected( $the_options['cookie_banner_animation'], 'fade' ); ?>><?php _e( 'Fade', 'myagileprivacy' ); ?></option>
                </select>
                </div> <!-- col-sm-7 -->
            </div> <!-- row -->
            ...
            <div class="row mb-4">
                ...
                <?php _e( 'Enable banner heading', 'myagileprivacy' ); ?>
                </label>
                ...
                <div class="col-sm-7">
                    ...
                    <div class="form-text">
                        <?php
                            _e( "Choose if the banner title should be visible", 'myagileprivacy' );
                        ?>.
                    </div>
                </div> <!-- /.col-sm-6 -->
            ...
            <div class="row mb-4 show_banner_title">
                <label for="bar_heading_text_field" class="col-sm-5 col-form-label">
                    <?php _e( 'Banner title', 'myagileprivacy' ); ?>
                </label>

                <div class="col-sm-7">
                    <input type="text" data-preview="title_text" class="form-control" id="bar_heading_text_field" name="bar_heading_text_field" value="<?php echo esc_attr(stripslashes($the_options['bar_heading_text']))  ?>" />
                </div> <!-- /.col-sm-6 -->
            </div> <!-- row -->
            ...
            <div class="row mb-4">
                <label for="notify_message_v2_field" class="col-sm-5 col-form-label">
                    <?php _e( 'Message', 'myagileprivacy' ); ?>
                </label>

                <div class="col-sm-7">
                    <?php
                        echo '<textarea id="notify_message_v2_field" name="notify_message_v2_field" class="form-control text_style" rows="9" style="font-size:12px;">';
                        echo apply_filters( 'format_to_edit', esc_attr(stripslashes($the_options['notify_message_v2']))) . '</textarea>';
                    ?>


                    <div class="form-text">
                        <?php _e( 'Example code:', 'myagileprivacy' ); ?>
                        <br>
                        <textarea class="text_style form-control" rows="9" style="font-size:12px" disabled><?php _e( 'This website uses technical and profiling cookies. Clicking on "Accept" authorises all profiling cookies. Clicking on "Refuse" or the X will refuse all profiling cookies. By clicking on "Customise" you can select which profiling cookies to activate.[myagileprivacy_extra_info]', 'myagileprivacy' ); ?></textarea>
                    </div>
            ...
            <div class="row mb-4 d-none">
                <label for="with_css_effects_field" class="col-sm-5 col-form-label">
                    <?php _e( 'Enable shadows and rounding effects', 'myagileprivacy' ); ?>
                </label>
                ...
                <div class="col-sm-7">
                    <div class="styled_radio d-inline-flex">
                        <div class="round d-flex me-4">
                            ...
                            <label for="with_css_effects_field" class="me-2 label-checkbox"></label><?php _e( 'Enable shadows and rounding effects', 'myagileprivacy' ); ?>
            ...
            <div class="row mb-4">
                <label for="text_size_field" class="col-sm-5 col-form-label">
                    <?php _e( 'Cookie Banner Font Size', 'myagileprivacy' ); ?>
                </label>
                <div class="col-sm-7">
                <div class="input-group">
                <input type="number" min="4" max="50" class="form-control" id="text_size_field" name="text_size_field" value="<?php echo esc_attr(stripslashes($the_options['text_size']))  ?>" />
                    ...
                    <div class="form-text">
                        <?php _e( 'Insert the font size for the cookie banner heading, text buttons and for the blocked content notification bar text, in pixel <small>(suggested value: 18)</small>', 'myagileprivacy' ); ?>.
                    </div>
                </div> <!-- col-sm-7 -->
            </div> <!-- row -->
            ...
            <div class="row mb-4">
                <label for="text_lineheight_field" class="col-sm-5 col-form-label">
                    <?php _e( 'Cookie Banner Line Height', 'myagileprivacy' ); ?>
                </label>
                <div class="col-sm-7">
                <div class="input-group">
                <input type="number" min="0" max="100" class="form-control" id="text_lineheight_field" name="text_lineheight_field" value="<?php echo esc_attr(stripslashes($the_options['text_lineheight']))  ?>" />
                    ...
                    <div class="form-text">
                        <?php _e( 'Insert the line height for the cookie banner heading, text buttons and for the blocked content notification bar text, in pixel <small>(suggested value: 30)</small>', 'myagileprivacy' ); ?>.
                    </div>
                </div> <!-- col-sm-7 -->
            </div> <!-- row -->
            ...
            <div class="row mb-4">
                <label for="color_preset" class="col-sm-5 col-form-label">
                    <?php _e( 'Color Preset', 'myagileprivacy' ); ?>
                </label>

                <div class="col-sm-7">
                    <select name="color_preset" class="form-control" id="color_preset">
                        <option value="none"><?php _e( 'Select a preset', 'myagileprivacy' ); ?></option>
                        <option value="light"><?php _e( 'Light', 'myagileprivacy' ); ?></option>
                        <option value="dark"><?php _e( 'Dark', 'myagileprivacy' ); ?></option>
                        <option value="parchment"><?php _e( 'Ancient Parchment', 'myagileprivacy' ); ?></option>
                        <option value="wintersky"><?php _e( 'Winter Sky', 'myagileprivacy' ); ?></option>
                        <option value="mistyforest"><?php _e( 'Misty Forest', 'myagileprivacy' ); ?></option>
                        <option value="greentea"><?php _e( 'Green Tea', 'myagileprivacy' ); ?></option>
                        <option value="lavender"><?php _e( 'Lavender Blooms', 'myagileprivacy' ); ?></option>
                    </select>

                    <div class="form-text">
                        <?php
                            _e( "Select a color preset for the cookie banner, or customize by your own",'myagileprivacy' );
                        ?>.
                    </div>
                </div> <!-- /.col-sm-6 -->
            </div> <!-- row -->
            ...
            <div class="row mb-4">
                <label for="background_field" class="col-sm-5 col-form-label">
                    <?php _e( 'Cookie Banner Color', 'myagileprivacy' ); ?>
                </label>
                ...
                <div class="col-sm-7">
                    ...
                    <div class="form-text">
                        <?php
                            _e( "Select the background color of the cookie banner",'myagileprivacy' );
                        ?>.
                    </div>
                </div> <!-- /.col-sm-6 -->
            </div> <!-- row -->
            ...
            <div class="show_banner_title">
                ...
                <div class="row mb-4">
                    <label for="heading_background_color_field" class="col-sm-5 col-form-label">
                        <?php _e( 'Heading background Color', 'myagileprivacy' ); ?>
                    </label>
                    <div class="col-sm-7">
                        <?php
                        ...
                        <div class="form-text">
                            <?php
                                _e( "Select the text color of the cookie banner",'myagileprivacy' );
                            ?>.
                        </div>
                    </div> <!-- /.col-sm-6 -->
                </div> <!-- row -->
                ...
                <div class="row mb-4">
                    <label for="heading_text_color_field" class="col-sm-5 col-form-label">
                        <?php _e( 'Heading text Color', 'myagileprivacy' ); ?>
                    </label>
                    <div class="col-sm-7">
                        <?php
            ...
            <div class="row mb-4">
                <label for="text_field" class="col-sm-5 col-form-label">
                    <?php _e( 'Text Color', 'myagileprivacy' ); ?>
                </label>
        ...
        <div class="consistent-box">
            <h4 class="mb-4">
                <i class="fa-regular fa-browser"></i>
                <?php _e( 'Buttons Customization', 'myagileprivacy' ); ?>
            </h4>
            ...
            <div id="map_buttons_background_alert" class="alert alert-warning d-none" role="alert">
                <p>
                    ...
                    <strong><?php
                        ...
                        _e( 'Attention: We strongly recommend keeping the background colors of the buttons aligned and identical.', 'myagileprivacy' );
                    ?></strong>
                    ...
                    <?php
                        ...
                        _e( 'Using different colors might be perceived as a "dark pattern," potentially misleading users and conflicting with privacy regulations. To ensure the highest level of compliance for your site, please consider using the same background color.', 'myagileprivacy' );
                    ?>
                ...
                <p class="mb-0">
                    <?php
                        ...
                        _e('You can use the default color settings or <a href="#" role="button" class="standardize_colors_button">click here to standardize the colors</a>.', 'myagileprivacy' );
                    ?>
                </p>
            </div>
            ...
            <div class="row mb-4">
                <label for="is_on_field_yes" class="col-sm-5 col-form-label">
                <?php _e( 'Show Buttons icon', 'myagileprivacy' ); ?>
                </label>
            ...
            <div class="card fullwidth">
                <div class="row mb-3">
                    <div class="col-sm-12">
                        <h6 class="h5"><?php _e( 'Accept button', 'myagileprivacy' ); ?></h6>
                    </div>
                </div>

                <div class="row">
                    <div class="col-sm-4 text-center">
                        <div><label for="button_accept_text_field"><strong><?php _e( 'Text', 'myagileprivacy' ); ?></strong></label></div>
                        <input type="text" class="form-control" id="button_accept_text_field" name="button_accept_text_field" data-preview="accept-text" value="<?php echo esc_attr(stripslashes($the_options['button_accept_text'])) ?>" />
                    </div>

                    <div class="col-sm-4 text-center">
                        <div><label for="button_accept_link_color_field"><strong><?php _e( 'Text colour', 'myagileprivacy' ); ?></strong></label></div>
                        <?php
                    ...
                    <div class="col-sm-4 text-center">
                        <div><label for="button_accept_button_color_field"><strong><?php _e( 'Background colour', 'myagileprivacy' ); ?></strong></label></div>
                        <?php
            ...
            <div class="card fullwidth">
                <div class="row mb-3">
                    <div class="col-sm-12">
                        <h6 class="h5"><?php _e( 'Refuse button', 'myagileprivacy' ); ?></h6>
                    </div>
                </div>

                <div class="row">
                    <div class="col-sm-4 text-center">
                        <div><label for="button_reject_text_field"><strong><?php _e( 'Text', 'myagileprivacy' ); ?></strong></label></div>
                        <input type="text" class="form-control" id="button_reject_text_field" name="button_reject_text_field" value="<?php echo esc_attr(stripslashes($the_options['button_reject_text'])) ?>" />
                    </div>

                    <div class="col-sm-4 text-center">
                        <div><label for="button_reject_link_color_field"><strong><?php _e( 'Text colour', 'myagileprivacy' ); ?></strong></label></div>
                        <?php
                    ...
                    <div class="col-sm-4 text-center">
                        <div><label for="button_reject_button_color_field"><strong><?php _e( 'Background colour', 'myagileprivacy' ); ?></strong></label></div>
                        <?php
            ...
            <div class="card fullwidth">
                <div class="row mb-3">
                    <div class="col-sm-12">
                        <h6 class="h5"><?php _e( 'Customize button', 'myagileprivacy' ); ?></h6>
                    </div>
                </div>

                <div class="row">
                    <div class="col-sm-4 text-center">
                        <div><label for="button_customize_text_field"><strong><?php _e( 'Text', 'myagileprivacy' ); ?></strong></label></div>
                        <input type="text" class="form-control" id="button_customize_text_field" name="button_customize_text_field" value="<?php echo esc_attr(stripslashes($the_options['button_customize_text'])) ?>" />
                    </div>

                    <div class="col-sm-4 text-center">
                        <div><label for="button_customize_link_color_field"><strong><?php _e( 'Text colour', 'myagileprivacy' ); ?></strong></label></div>
                        <?php
                    ...
                    <div class="col-sm-4 text-center">
                        <div><label for="button_customize_button_color_field"><strong><?php _e( 'Background colour', 'myagileprivacy' ); ?></strong></label></div>
                        <?php
    ...
    <div class="col-sm-4">
        <div id="live-preview">
            <div class="row align-items-center mb-4">
                <div class="col-7">
                    <h6 class="text-center"><?php _e( 'Your website preview','myagileprivacy' ); ?></h6>
                </div>
                <div class="col-5">
            ...
            <div class="browser">
                <div id="preview-cookiebanner" class="<?php echo esc_attr( $preview_cookiebanner_classes ); ?>" style="<?php echo $preview_cookiebanner_styles.$border_radius_style; ?>">

                    <div id="preview-title" style="<?php echo $preview_title_styles; ?>">
                        <?php
                            echo ($the_options['bar_heading_text'] == '' ? '<div class="banner-title-logo" style="background:'.esc_attr(stripslashes($the_options['heading_text_color'])).';"></div> My Agile Privacy' : esc_attr(stripslashes($the_options['bar_heading_text'])));
            ...
            <div class="mt-5">
                <h6 class="text-center"><?php _e( 'Accept button detailed preview','myagileprivacy' ); ?></h6>
