    ...
    <div class="col-sm-8">
        ...
        <div class="consistent-box">
            <h4 class="mb-4">
                ...
                <?php _e( 'Cookie Policy', 'myagileprivacy' ); ?>
            </h4>

            <div class="row mb-4">
                <div class="col-sm-12">
                    <?php _e( 'The cookie policy page is the place where you tell user about how cookies works and what are the cookies used by the website.', 'myagileprivacy' ); ?><br>
                    <br>
                    <?php _e( 'The shortcode for the Cookie Policy text is:', 'myagileprivacy' ); ?><br>
            ...
            <div class="row mb-4">
                <label for="is_cookie_policy_url_field" class="col-sm-5 col-form-label">
                    <?php _e( 'Url or Page ?', 'myagileprivacy' ); ?>
                </label>
            ...
            <div class="row mb-4 is_cookie_policy_url_yes_detail displayNone">
                <label for="cookie_policy_url_field" class="col-sm-5 col-form-label">
                    <?php _e( 'Enter URL', 'myagileprivacy' ); ?>
                </label>
                ...
                <div class="col-sm-7">
                    ...
                    <div class="form-text">
                        <?php _e( "Insert here the URL to the cookie policy page.", 'myagileprivacy' ); ?><br><br>
                    </div>
                </div> <!-- /.col-sm-6 -->
            ...
            <div class="row mb-4 is_cookie_policy_url_no_detail displayNone">
                <label for="cookie_policy_page_field" class="col-sm-5 col-form-label">
                    <?php _e( 'Choose Page', 'myagileprivacy' ); ?>
                </label>

                <div class="col-sm-7">

                    <select name="cookie_policy_page_field" class="form-control" id="cookie_policy_page_field">
                        <option value="0">--<?php _e( 'Select One','myagileprivacy' ); ?>--</option>
                        <?php
                    ...
                    <div class="form-text">
                        <?php _e( "Don't forget to associate the right page: we suggest you to create a new page, put the right shortcode in the page editor, and associate the new created page here.", 'myagileprivacy' ); ?>
                    </div>
        ...
        <div class="consistent-box">
            <h4 class="mb-5">
                ...
                <?php _e( 'Personal Data Policy', 'myagileprivacy' ); ?>
            </h4>

            <div class="row mb-5">
                <div class="col-sm-12">
                    <?php _e( "The personal data page is the place where you tell user about how do you use personal data, for example for answering back a user form submission.", 'myagileprivacy' ); ?><br>
                    <br>
                    <?php _e( "Please remember also to ask user consent, adjusting your forms, adding the link to the selected page. You have got a shortcode for helping you to insert the right link.", 'myagileprivacy' ); ?><br>
                    <br>
                    <?php _e( "The shortcode for the Personal Data Policy text is:", 'myagileprivacy' ); ?><br>
                    <code>[myagileprivacy_fixed_text text="personal_data_policy"]</code><br>
                    <br>
                    <?php _e( "The shortcode for the Personal Data Policy page URL is:", 'myagileprivacy' ); ?><br>
            ...
            <div class="row mb-4 is_personal_data_policy_url_yes_detail displayNone">
                ...
                <div class="col-sm-7">
                    ...
                    <div class="form-text">
                        <?php _e( "Insert here the URL to the personal data policy page.", 'myagileprivacy' ); ?><br><br>
                    </div>
                </div> <!-- /.col-sm-6 -->
        ...
        <div class="consistent-box <?php if( $the_options['pa'] != 1){echo 'forbiddenArea';} ?>">
            ...
            <h4 class="mb-4">
                ...
                <?php _e( 'LPD Privacy Regulation', 'myagileprivacy' ); ?>
            </h4>

            <div class="row mb-4">
                <div class="col-sm-12">

                    <b><?php _e( "The LPD is Switzerland's Privacy regulation.", 'myagileprivacy' ); ?></b><br>
                    <?php _e( 'By activating the management of Swiss LPD, you declare to be familiar with Swiss privacy legislation and to fall within its scope of application.', 'myagileprivacy' ); ?><br>
                    <?php _e( 'You acknowledge that, depending on the personal data processing activities you will undertake, you will need to comply with both GDPR and LPD as well as other local regulations where applicable.', 'myagileprivacy' ); ?><br>
                    <?php _e( 'You have also considered the potential appointment of a Data Protection Advisor as provided by Swiss LPD.', 'myagileprivacy' ); ?><br>
                    <?php _e( 'Lastly, you declare that you have reviewed the <a href="https://www.bj.admin.ch/bj/it/home/staat/datenschutz/internationales/anerkennung-staaten.html" target="_blank">list of States</a> where, according to the LPD, you may possibly transfer the data subject to processing.', 'myagileprivacy' ); ?>
                </div>
            </div>

            <div class="row mb-4">
                <label for="display_lpd_field" class="col-sm-5 col-form-label">
                    <?php _e( 'Enable LPD notice', 'myagileprivacy' ); ?>
                </label>
                    ...
                    <div class="styled_radio d-inline-flex">
                        <div class="round d-flex me-4">
                            ...
                            <label for="display_lpd_field">
                                <?php _e( 'Yes, I fall under the scope of LPD and I want to display the corresponding notice.', 'myagileprivacy' ); ?>
                            </label>
                        </div>
                    </div> <!-- ./ styled_radio -->
        ...
        <div class="consistent-box <?php if( $the_options['pa'] != 1){echo 'forbiddenArea';} ?>">
            ...
            <h4 class="mb-4">
                ...
                <?php _e( 'CCPA Privacy Regulation', 'myagileprivacy' ); ?>
            </h4>

            <div class="row mb-4">
                <div class="col-sm-12">

                    <b><?php _e( 'The CCPA is the California Privacy regulation.', 'myagileprivacy' ); ?></b><br>
                    <?php _e( 'You fall under the scope of CCPA when both of these conditions apply:', 'myagileprivacy' ); ?><br>
                    <?php _e( '-you have a business with an annual gross revenue exceeding $25 million, or 50% of the revenue comes from selling personal data, or you buy, receive, sell, or share personal information of 50000 or more consumers annually for commercial purposes', 'myagileprivacy' ); ?><br>
                    <?php _e( '-you target California residents.', 'myagileprivacy' ); ?><br>
                </div>
            </div>

            <div class="row mb-4">
                <label for="display_ccpa_field" class="col-sm-5 col-form-label">
                    <?php _e( 'Enable CCPA notice', 'myagileprivacy' ); ?>
                </label>
                    ...
                    <div class="styled_radio d-inline-flex">
                        <div class="round d-flex me-4">
                            ...
                            <label for="display_ccpa_field">
                                <?php _e( 'Yes, I fall under the scope of CCPA and I want to display the corresponding notice.', 'myagileprivacy' ); ?>
                            </label>
                        </div>
                    </div> <!-- ./ styled_radio -->
